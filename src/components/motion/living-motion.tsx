  ...
  useEffect(() => {
    ...
    const heroes = Array.from(
      document.querySelectorAll<HTMLElement>(
        '.sorvyra-commerce-hero, .sorvyra-nigeria-hero, .atiloszy-commerce-hero, .zee-nigeria-commerce-hero, .denald-commerce-hero, .sorvyra-qatar-hero, .zee-comfort-commerce-hero',
      ),
    );
